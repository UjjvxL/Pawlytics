...
const LAYERS = [
  {
    ...
    items: [
      { name: "OSM Roads", desc: "OpenStreetMap road network for Noida pilot area", status: "active" },
      { name: "Schools (Pilot)", desc: "Selected schools in the Sector 62 pilot zone", status: "active" },
      ...
      { name: "Risk Zones (Sector Level)", desc: "Composite risk score per sector", status: "active" },
  ...
  },
  {
    ...
    items: [
      { name: "ABC Sterilization Coverage", desc: "Animal Birth Control sterilization coverage by sector", status: "planned", note: "Requires Noida Authority data partnership" },
      { name: "Vaccination Coverage (Rabies)", desc: "Dog vaccination coverage layer per sector", status: "planned", note: "Requires municipal health data" },
      { name: "Municipal Sector Boundaries (Full)", desc: "All Noida sector polygons with metadata", status: "planned", note: "Open data pending" },
  ...
  },
  {
    ...
    items: [
      { name: "Noida Authority Complaint Registry Integration", desc: "Direct API ingestion from Noida Authority citizen portal", status: "future", note: "FUTURE — Government API required" },
