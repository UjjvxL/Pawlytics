...
/**
 * Image component supporting responsive image sizing and WebP optimization.
 * Rendered container is scaled per device pixel ratio; fittingType="fill"
 * crops server-side. Failed transforms retry the original URL.
 */
